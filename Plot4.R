...
par(mfrow = c(2,2))
plot(new_exdata_sub$dateandtime,new_exdata_sub$Global_active_power, xlab = "", ylab = "Global Active Power", type = "l", lwd =2)
plot(new_exdata_sub$dateandtime,new_exdata_sub$Voltage, xlab = "datetime", ylab = "Voltage", type = "l", lwd = 2)
...
plot(new_exdata_sub$dateandtime,new_exdata_sub$Global_reactive_power, xlab = "datetime", type = "l", lwd =2)
dev.off()